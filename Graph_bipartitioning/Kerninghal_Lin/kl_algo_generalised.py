      ...
      for k in i:                                                                         ## Reading each letter
        ...
        if k != '\n' and k == ',':
          if d[linecount][countelement+1] != '\n':
            ...
            if prev not in array4vertex1:
                   
                  array4vertex1.append(prev)
                  countvertex = countvertex + 1
                  
                 
            if post not in array4vertex1:
                  array4vertex1.append(post)
...
ug.add_vertex(countvertex)                                 ## The vertex are set to be 8 in number, but the user can decide which all are the nets
      ...
      for k in i:                                                                         ## Reading each letter
        ...
        if k != '\n' and k == ',':
          if d[linecount][countelement+1] != '\n':
            ...
            if prev not in array4vertex2:
                   
                  array4vertex2.append(prev)
                  countvertex = countvertex + 1
                  
                 
            if post not in array4vertex2:
                  array4vertex2.append(post)
...
i = 0
while (i < (countvertex/2)):
     
    v_partition[ug.vertex(i)] = 1
    v_partition[ug.vertex(i+(countvertex/2))] = 2                 ####  assigned two different partitions 
    i+=1
